...
#给定路径，读取Excel文件，有一个方法get_target_sheet，获得相应的sheet
class Excel_file(object):
    def __init__(self,path,target_sheetname=None):
        self.path=path
...
def Write_Excel_file(path=None,fengdianchang_list=None,MTBF=None,MTTR=None,TBA=None,guzhangcishu=None,jingjisunshi=None):
...
def draw_picture(fengdianchang_list=None,MTBF=None,MTTR=None,TBA=None,guzhangcishu=None,jingjisunshi=None):
    pass
e=Excel_file(path)
